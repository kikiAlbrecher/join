...
/**
 * Event listener that hides all visible task card menu popups when a click event occurs anywhere in the document.
 * 
 * This function listens for a `click` event on the entire document and, upon any click, it will loop through all
 * elements with the class `.task-card-menu-pop-up` and set their `display` style property to `"none"`,
 * effectively hiding the popups.
 *
 * @name hidePopupsOnClick
